...
populations 'A' and 'C', aggregated to annual resolution with staggered
year ranges. Designed to test the combination of multi-population
analysis with aggregate annual data. Filter to single population for
simple annual-only testing. This dataset follows the methodology
