# Contributing to bboudata

This outlines how to propose a change to bboudata.
...
- Begin commit or merge messages with `-` to indicate user facing
  ...
  [fledge](https://github.com/krlmlr/fledge) to automatically generate
  the NEWS.md file.
...
Code of
Conduct](https://poissonconsulting.github.io/CODE_OF_CONDUCT.md). By
